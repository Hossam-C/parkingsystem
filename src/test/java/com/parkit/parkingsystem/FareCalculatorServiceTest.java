...
public class FareCalculatorServiceTest {
    ...
    public void calculateFareCarWithLessThanHalfAnHourParkingTime(){
        Date inTime = new Date();
        inTime.setTime( System.currentTimeMillis() - (  15 * 60 * 1000) );//15 mins parking time should give 0.25 * parking fare per hour
        Date outTime = new Date();
        ParkingSpot parkingSpot = new ParkingSpot(1, ParkingType.CAR,false);
    ...
    @Test
    public void calculateFareCarWithRecurringUserAnd90MinParkingTime() {
        Date inTime = new Date();
        inTime.setTime(System.currentTimeMillis() - (90 * 60 * 1000));//24 hours parking time should give 24 * parking fare per hour
        Date outTime = new Date();
        ParkingSpot parkingSpot = new ParkingSpot(1, ParkingType.CAR, false);
        ...
        //ticket.setNumberOfPaidTicket(2);

        fareCalculatorService.calculateFare(ticket);

        //Taking into account the free 30mn and the -5%
